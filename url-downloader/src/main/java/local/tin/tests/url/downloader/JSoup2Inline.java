 ...
 * @author benitodarder
 */
public class JSoup2Inline {

    public static final String USAGE_STRING = "Usage: java -cp url-downloader.jar local.tin.tests.url.downloader.JSoup2Inline <URL>";
    private static final Logger LOGGER = Logger.getLogger(JSoup2Inline.class);
    ...
    public static void main(String[] args) throws TransformerException, IOException {
        if (args.length != 1) {
            ...
            JSoupUtils.getInstance().convertToInlineImages(jsc);
